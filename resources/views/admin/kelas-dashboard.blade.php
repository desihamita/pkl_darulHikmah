                    ...
                    @if (count($kelas) > 0)
                        @foreach ($kelas as $item)
                            <tr>
                                ...
                                <td>{{ $item->semester }}</td>
                                <td>
                                    <button class="btn btn-info updateButton" data-id="{{ $item->id }}" data-kelas="{{ $item->class }}" data-semester="{{ $item->semester }}" data-toggle="modal" data-target="#modal-update">Update</button>
